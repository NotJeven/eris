...
tellraw @a[score_inGame_min=-1,score_inGame=-1] [{"text":"Verison: "},{"text":"2.2","color":"red"},{"text":" Release Candidate 1 (Minecraft 1.12.2)"}]
execute @e[type=armor_stand,name=vEggServer,score_var_min=1,score_var=1] ~ ~ ~ tellraw @a[score_ingame_min=-1,score_inGame=-1] [{"text":"Powered by: "},{"text":"Vanteklabs","color":"red"},{"text":"®","color":"white"}]
