...
execute as @e[name=TheBestGinger9] run replaceitem entity YouRedstone armor.head player_head{SkullOwner:TheBestGinger9} 1
replaceitem entity Anster armor.head player_head{SkullOwner:MHF_OakLog,display:{Name:NotAnsterLog}} 1
execute as @e[name=TheBestGinger9] run replaceitem entity Buikes armor.head player_head{SkullOwner:TheBestGinger9} 1
