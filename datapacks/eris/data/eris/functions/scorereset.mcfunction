...
execute as @e[type=armor_stand,name=vSwapTeam,scores={var=1}] run tellraw @a [{"text":"Teams have been "},{"text":"switched","color":"#FF9FD6"},{"text":"!"}]
execute as @e[type=armor_stand,name=vSwapTeam,scores={var=1}] run title @a subtitle [{"text":"Teams have been "},{"text":"switched","color":"#FF9FD6"},{"text":"!"}]
