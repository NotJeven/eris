...
execute if entity @e[type=armor_stand,name=vTime,scores={var=-901..}] run gamemode survival @a[team=team1,scores={triggerTeam=1},gamemode=!survival]
execute if entity @e[type=armor_stand,name=vTime,scores={var=-901..}] run tp @a[team=team1,scores={triggerTeam=1}] 1193 30 0 90 0
