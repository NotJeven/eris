...
execute as @e[type=armor_stand,name=vReady2,scores={var=11}] run title @a subtitle {"text":"Invaders","color":"dark_purple","extra":[{"text":" are ready!","color":"white"}]}
execute as @e[type=armor_stand,name=vReady2,scores={var=11}] run tellraw @a {"text":"Invaders","color":"dark_purple","extra":[{"text":" are ready!","color":"white"}]}
execute as @e[type=armor_stand,name=vReady2,scores={var=11}] at @s run playsound block.anvil.land master @a ~ ~ ~ 1 1.5 1
...
execute as @e[type=armor_stand,name=vReady2,scores={var=10}] run title @a subtitle {"text":"Invaders","color":"dark_purple","extra":[{"text":" are not ready!","color":"white"}]}
execute as @e[type=armor_stand,name=vReady2,scores={var=10}] run tellraw @a {"text":"Invaders","color":"dark_purple","extra":[{"text":" are not ready!","color":"white"}]}
execute as @e[type=armor_stand,name=vReady2,scores={var=10}] at @s run playsound block.anvil.land master @a ~ ~ ~ 1 1 1
