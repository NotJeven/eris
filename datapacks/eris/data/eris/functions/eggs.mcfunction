...
execute as @e[name=TheBestGinger13] run item replace entity YouRedstone armor.head with player_head{SkullOwner:TheBestGinger13} 1
execute as @e[name=TheBestGinger13] run item replace entity Movie_Extra armor.head with player_head{SkullOwner:TheBestGinger13} 1
execute as @e[name=TheBestGinger13] run item replace entity Buikes armor.head with player_head{SkullOwner:TheBestGinger13} 1
item replace entity Anster armor.head with player_head{SkullOwner:MHF_OakLog,display:{Name:NotAnsterLog}} 1
