...
effect give @a[scores={timeSinceDeath=1..,inGame=1,respawn=1}] minecraft:regeneration 999999 0 true
...
execute as @a[team=team2,scores={timeSinceDeath=1..,inGame=1,respawn=1}] at @s run tp @s ~ ~ ~
execute as @a[team=team1,scores={timeSinceDeath=1..,inGame=1,respawn=1}] at @s run tp @s ~ ~ ~
