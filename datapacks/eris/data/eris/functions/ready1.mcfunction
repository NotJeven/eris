...
execute as @e[type=armor_stand,name=vReady1,scores={var=11}] run title @a[team=team1] subtitle {"text":"Defenders","color":"aqua","extra":[{"text":" are ready!","color":"white"}]}
execute as @e[type=armor_stand,name=vReady1,scores={var=11}] run tellraw @a[team=team1] {"text":"Defenders","color":"aqua","extra":[{"text":" are ready!","color":"white"}]}
execute as @e[type=armor_stand,name=vReady1,scores={var=11}] at @s run playsound block.anvil.land master @a[team=team1] ~ ~ ~ 1 1.5 1
...
execute as @e[type=armor_stand,name=vReady1,scores={var=10}] run title @a[team=team1] subtitle {"text":"Defenders","color":"aqua","extra":[{"text":" are not ready!","color":"white"}]}
execute as @e[type=armor_stand,name=vReady1,scores={var=10}] run tellraw @a[team=team1] {"text":"Defenders","color":"aqua","extra":[{"text":" are not ready!","color":"white"}]}
execute as @e[type=armor_stand,name=vReady1,scores={var=10}] at @s run playsound block.anvil.land master @a[team=team1] ~ ~ ~ 1 1 1
execute as @e[type=armor_stand,name=vReady1,scores={var=10}] run team join notReady §nDefenders
title @a[team=team1] title ""
