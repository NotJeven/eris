...
item replace entity @a[team=team2,scores={respawn=0,timeSinceDeath=..0,inGame=1..,itemHelm=..0}] armor.head with leather_helmet{Damage:0s,Unbreakable:1b,display:{color:9634007},Enchantments:[{id:"minecraft:projectile_protection",lvl:1}]} 1
item replace entity @a[team=team2,scores={respawn=0,inGame=1..,timeSinceDeath=..0,itemChest=..0}] armor.chest with leather_chestplate{Damage:0s,Unbreakable:1b,display:{color:9634007},Enchantments:[{id:"minecraft:projectile_protection",lvl:1}]} 1
item replace entity @a[team=team2,scores={respawn=0,inGame=1..,timeSinceDeath=..0,itemPant=..0}] armor.legs with leather_leggings{Damage:0s,Unbreakable:1b,display:{color:9634007},Enchantments:[{id:"minecraft:projectile_protection",lvl:1}]} 1
item replace entity @a[team=team2,scores={respawn=0,inGame=1..,timeSinceDeath=..0,itemBoot=..0}] armor.feet with leather_boots{Damage:0s,Unbreakable:1b,display:{color:9634007},Enchantments:[{id:"minecraft:projectile_protection",lvl:1}]} 1
item replace entity @a[team=team1,scores={respawn=0,inGame=1..,itemHelm=..0,timeSinceDeath=..0}] armor.head with leather_helmet{Damage:0s,Unbreakable:1b,display:{color:2606585}} 1
item replace entity @a[team=team1,scores={respawn=0,inGame=1..,itemChest=..0,timeSinceDeath=..0}] armor.chest with leather_chestplate{Damage:0s,Unbreakable:1b,display:{color:2606585}} 1
item replace entity @a[team=team1,scores={respawn=0,inGame=1..,itemPant=..0,timeSinceDeath=..0}] armor.legs with leather_leggings{Damage:0s,Unbreakable:1b,display:{color:2606585}} 1
item replace entity @a[team=team1,scores={respawn=0,inGame=1..,itemBoot=..0,timeSinceDeath=..0}] armor.feet with leather_boots{Damage:0s,Unbreakable:1b,display:{color:2606585}} 1
